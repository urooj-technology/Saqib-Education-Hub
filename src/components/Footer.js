      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">info@noorsaqib.edu</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="w-4 h-4 text-gray-400" />
                <span className="text-gray-300">+93 123 456 789</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            {/* © 2024 Noor Saqib Education Hub. All rights reserved. */}
            {new Date().getFullYear()} developed with ❤️ by  <a href="https://uroojtech.com" className="text-white hover:text-gray-300 transition-colors">urooj technologies</a>. All rights reserved.
          </p>
